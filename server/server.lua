...
RegisterServerEvent('ghost_bounty:AddSomeMoney')
AddEventHandler('ghost_bounty:AddSomeMoney', function()
...
RegisterServerEvent('ghost_bounty:valreward')
AddEventHandler('ghost_bounty:valreward', function()
    local _source = source
